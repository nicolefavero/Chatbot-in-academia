################################################################################
#  CHATBOT WITH Llama 3.3 FOR SUMMARIZATION & Llama-2-7B FOR EXTRACTION  #
################################################################################

'''
Reason: To save on GPU hours while maintaining academic justification, we use a smaller 
Llama-style model (Llama-2-7B-Chat) for the extraction phase. This model extracts graph 
elements (entities and relationships) from text chunks, and then Llama 3.3 is used for 
high-quality summarization and final query answering. Intermediate results such as 
extracted entities, relationships, and the knowledge graph are cached to disk.
'''
...
# Use Leiden exclusively for community detection
import igraph as ig
import leidenalg
...
# -----------------------------------------------------------------------------
# 3. LLM-Based Extraction of Graph Elements (using Llama-2-7B)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# 4. Build a Knowledge Graph from Extracted Elements
# -----------------------------------------------------------------------------
...
# (Optional) Merge similar nodes using SPECTER2 embeddings
...
# -----------------------------------------------------------------------------
# 5. Community Detection & Summarization (using Llama 3.3)
# -----------------------------------------------------------------------------
...
def main():
    ...
    # Define your PDF paths (update with your actual paths)
    pdf_paths = [
