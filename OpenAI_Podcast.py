    ...
    if matched_doc:
        ...
        try:
            response = client.chat.completions.create(
                model="gpt-4o-mini",
                messages=[
                    {"role": "system", "content": "You are a helpful, engaging conversational podcast assistant. Your scope is to help users generate podcast scripts based on accademic papers."},
